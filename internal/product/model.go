...
type Product struct {
	...
	Category        string         `gorm:"type:varchar(100);not null;comment:Kategori" json:"category" form:"category"`
	Unit            string         `gorm:"type:varchar(50);not null;comment:Satuan" json:"unit" form:"unit"`
