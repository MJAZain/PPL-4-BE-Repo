...
type Supplier struct {
	...
	Name          string `gorm:"type:varchar(255);not null;uniqueIndex" json:"name" form:"name"`
	...
	Email         string `gorm:"type:varchar(255);uniqueIndex" json:"email,omitempty" form:"email"`
